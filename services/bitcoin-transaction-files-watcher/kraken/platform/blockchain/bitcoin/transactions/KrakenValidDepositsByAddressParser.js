 ...
 * },
 */
class KrakenValidDepositsByAddressParser {

    /**
     * Makes an instance of the parser for the parsing of the transactions data files.
     *
     * @param config full config of the service.
     */
    constructor({config}) {
    ...
    /**
     * Parses the transactions within the given data file path.
     * @param {String} transactionsDataFilePath is the full path of the file in the fs. Can be used with ~ as well.
     */
    async parse(transactionsDataFilePath) {
